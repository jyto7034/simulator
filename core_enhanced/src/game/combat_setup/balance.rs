//! Shared combat balance thresholds used by preview warnings and damage feedback.
//!
//! Keep these values small and explicit. This module is not an auto-balance
//! solver; it is the single policy table for coarse AD/AP readability signals.
